...
{
    public partial class EventPerformance_organizer : UserControl
    {
        public EventPerformance_organizer()
        {
            InitializeComponent();
        }
        ...
        private void EventPerformance_organizer_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = "select * from event where eIsPublic=1 and eIsActive=1 and eCreatedBy=@creatorId and eCreatorRole='Organizer'";
                    ...
                    cmd.Parameters.AddWithValue("@creatorId", adminLoginInfo.userId);
