...
namespace eventManagementSystem.emsDataSet1TableAdapters {
...
SELECT eId, eName, eDisplayName, eType, eDate, eStartTime, eEndTime, eIsPublic, eNeedTicketing, eNeedParticipationConfirmation, eNeedLocation, eCapacity, eMaxCapacity, eTicketCount, eTicketPrice, eBudget, eMaxBudget, eIsActive FROM event WHERE (eId = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(emsDataSet1.eventDataTable dataTable) {
        ...
        public virtual emsDataSet1.eventDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            emsDataSet1.eventDataTable dataTable = new emsDataSet1.eventDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(emsDataSet1.eventDataTable dataTable) {
